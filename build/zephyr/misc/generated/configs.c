...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZTEST_STACK_SIZE, 4096);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAMERA_SERVICE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CAMERA_SERVICE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NULL_POINTER_EXCEPTION_DETECTION_MPU, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_SENSOR_DISTANCE_MM, 1000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADAR_CAMERA_FAILURE_RATE_PERCENT, 90);
